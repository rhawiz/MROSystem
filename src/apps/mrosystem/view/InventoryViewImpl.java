...
/*			assetsTabSheet.addStyleName(ValoTheme.TABSHEET_FRAMED);*/
	...
	private VerticalLayout buildViewInventoryTableControl(){
		...
		inventoryTableViewMode.addItem("Single Level");
		
		inventoryTableClassFilter = new Tree("Class Filter");
		inventoryTableClassFilter.setWidth(100,Unit.PERCENTAGE);

		inventoryTableClassFilter.setSizeFull();
		inventoryTableClassFilter.setMultiSelect(false);
		
		inventoryTableControl.addComponent(inventoryTableSearchBox);

		inventoryTableControl.addComponent(inventoryTableViewMode);
		inventoryTableControl.addComponent(inventoryTableClassFilter);
