...
public class AssetDetailsView extends Window {
...
/*			assetsTabSheet.addStyleName(ValoTheme.TABSHEET_FRAMED);*/
		...
		assetInfoGridLayout.setCaption("Asset Information");
		assetInfoGridLayout.setIcon(FontAwesome.INFO);
		...
		bomInfoGridLayout.setCaption("Bill of Material");
		bomInfoGridLayout.setIcon(FontAwesome.SITEMAP);
		...
		Label infoLabel = new Label("Double click on a compontent to display details.");
		infoLabel.addStyleName("sub-window");
		infoLabel.addStyleName("heading2");
		bomInfoGridLayout.addComponent(infoLabel);
			...
			bomTree.addItemClickListener(new ItemClickListener() {
				...
				public void itemClick(ItemClickEvent event) {
					if(event.isDoubleClick()){
						...
						new AssetDetailsHandler(new AssetDetailsView(),new AssetDetailsModel(((Part) event.getItemId()).getPartNo())).show();
					}
		...
		assetInfoWindowTabSheet.addTab(assetInfoGridLayout);
		assetInfoWindowTabSheet.addTab(bomInfoGridLayout);		
		mainLayout = assetInfoWindowTabSheet;
	}
	
	public void setAssetDetails(HashMap<String,Attribute> details){
		this.assetInfo = details;
	}
